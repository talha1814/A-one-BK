...
export default function BottomNav({ activeTab, onTabChange }) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-lg border-t border-stone-200/80 shadow-lg no-print md:hidden">
            ...
            >
              <div
                className={`p-1.5 rounded-xl transition-colors ${
                  isActive ? 'bg-rose-50 text-rose-600' : 'text-stone-500'
                }`}
              >
